...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(67, 103);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(203, 23);
			this->button1->TabIndex = 2;
			this->button1->Text = L"CONTACTOS PREVIOS ";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Form1::button1_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(67, 169);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(203, 23);
			this->button2->TabIndex = 3;
			this->button2->Text = L"NUEVA AGENDA ";
			this->button2->UseVisualStyleBackColor = true;
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(67, 233);
			...
			this->ClientSize = System::Drawing::Size(327, 319);
